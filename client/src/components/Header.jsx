    ...
    <nav>
      <div className="flex justify-between px-3 md:px-10 text-white  items-center">
        ...
        <div className="hidden md:flex justify-around items-center text-lg space-x-12">
          ...
          <Link to={"/login"}>
            <button className="text-white bg-blue-500 font-bold   py-2  rounded-full text-center transition duration-200 ease-in shadow-md hover:shadow-lg    border border-white hover:bg-blue-600 w-36 px-4 ">
              Log In
            </button>
          </Link>
        </div>
